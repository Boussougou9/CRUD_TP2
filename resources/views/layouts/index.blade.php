    ...
    <div>
                    ...
                    <div class="col-md-8 col-lg-7">
                        <div class="banner-content aos" data-aos="fade-up" data-aos-duration="3000">
                            ...
                            <form class="form" name="store" id="store" method="post"
                                action="https://kofejob.dreamstechnologies.com/html/template/project.html">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="work-box bg1" data-aos="zoom-in" data-aos-duration="1000">
                            <div class="work-content">
                                ...
                                <p>Get the perfect Developed project for your budget from our creative community.
                                </p>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-12 mx-auto text-center">
                        <div class="section-header aos" data-aos="fade-up">
                            ...
                            <p>At Freelancer, we believe that talent is borderless and opportunity should be too.
                            </p>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="project-item aos" data-aos="fade-up">
                            <div class="project-img">
                                <a href="project.html"><img src="assets/img/project/project-01.jpg"
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                        <div class="project-item aos" data-aos="fade-up">
                            <div class="project-img">
                                <a href="project.html"><img src="assets/img/project/project-02.jpg"
                                        alt="Img" class="img-fluid"></a>
                                <h6>Laravel</h6>
                            </div>
                            <div class="d-flex justify-content-between align-items-start">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                        <div class="project-item aos" data-aos="fade-up">
                            <div class="project-img">
                                <a href="project.html"><img src="assets/img/project/project-03.jpg"
                                        alt="Img" class="img-fluid"></a>
                                <h6>React</h6>
                            </div>
                            <div class="d-flex justify-content-between align-items-start">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                        <div class="project-item aos" data-aos="fade-up">
                            <div class="project-img">
                                <a href="project.html"><img src="assets/img/project/project-04.jpg"
                                        alt="Img" class="img-fluid"></a>
                                <h6>Angular</h6>
                            </div>
                            <div class="d-flex justify-content-between align-items-start">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                        <div class="project-item aos" data-aos="fade-up">
                            <div class="project-img">
                                <a href="project.html"><img src="assets/img/project/project-05.jpg"
                                        alt="Img" class="img-fluid"></a>
                                <h6>.NET</h6>
                            </div>
                            <div class="d-flex justify-content-between align-items-start">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                        <div class="project-item aos" data-aos="fade-up">
                            <div class="project-img">
                                <a href="project.html"><img src="assets/img/project/project-06.jpg"
                                        alt="Img" class="img-fluid"></a>
                                <h6>Java</h6>
                            </div>
                            <div class="d-flex justify-content-between align-items-start">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                        <div class="project-item aos" data-aos="fade-up">
                            <div class="project-img">
                                <a href="project.html"><img src="assets/img/project/project-07.jpg"
                                        alt="Img" class="img-fluid"></a>
                                <h6>Python</h6>
                            </div>
                            <div class="d-flex justify-content-between align-items-start">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                        <div class="project-item aos" data-aos="fade-up">
                            <div class="project-img">
                                <a href="project.html"><img src="assets/img/project/project-08.jpg"
                                        alt="Img" class="img-fluid"></a>
                                <h6>PHP</h6>
                            </div>
                            <div class="d-flex justify-content-between align-items-start">
        ...
        <section class="section developer">
            <div class="container">
                ...
                <div id="developers-slider" class="owl-carousel owl-theme developers-slider aos"
                    data-aos="fade-up">
                ...
                <div id="testimonial-slider" class="owl-carousel owl-theme testimonial-slider aos"
                    ...
                    <div class="review-blog">
                        ...
                        <div class="review-content">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Volutpat orci enim, mattis
                                nibh aliquam dui, nibh faucibus aenean.</p>
                            <div class="rating">
                                <i class="fas fa-star filled"></i>
                                <i class="fas fa-star filled"></i>
                                <i class="fas fa-star filled"></i>
                    ...
                    <div class="review-blog">
                        <div class="review-top d-flex align-items-center">
                            <div class="review-img">
                                <a href="review.html"><img class="img-fluid"
                                        src="assets/img/review/review-02.jpg" alt="Post Image"></a>
                            </div>
                            <div class="review-info">
                    ...
                    <div class="review-blog">
                        <div class="review-top d-flex align-items-center">
                            <div class="review-img">
                                <a href="review.html"><img class="img-fluid"
                                        src="assets/img/review/review-03.jpg" alt="Post Image"></a>
                            </div>
                            <div class="review-info">
                    ...
                    <div class="col-xl-4 col-md-6 d-flex">
                        ...
                        <div class="blog grid-blog aos" data-aos="fade-up">
                            ...
                            <div class="blog-content">
                                ...
                                <h3 class="blog-title"><a href="blog-details.html">Choose a Blogging
                                        Platform</a></h3>
                    ...
                    <div class="col-xl-4 col-md-6 d-flex">
                        ...
                        <div class="blog grid-blog aos" data-aos="fade-up">
                            ...
                            <div class="blog-content">
                                ...
                                <p class="mb-0">Choose a memorable and relevant domain name for your blog.
                                    Ideally, it should reflect your niche and personal brand.</p>
                                <div class="blog-read">
                                    <a href="blog-details.html">Read More <i
                                            class="fas fa-arrow-right ms-1"></i></a>
                                </div>
                    ...
                    <div class="col-xl-4 col-md-6 d-flex">
                        ...
                        <div class="blog grid-blog aos" data-aos="fade-up">
                            ...
                            <div class="blog-content">
                                ...
                                <p class="mb-0">Use analytics tools (e.g., Google Analytics) to track your
                                    blog's performance. Analyze which content performs well and adjust your strategy
                                    accordingly.</p>
                                <div class="blog-read">
                                    <a href="blog-details.html">Read More <i
                                            class="fas fa-arrow-right ms-1"></i></a>
                    ...
                    <div class="col-12">
                        <div class="register-job-blk">
                            <div class="job-content-blk aos" data-aos="fade-up">
                                ...
                                <p>Quisque pretium dolor turpis, quis blandit turpis semper ut. Nam malesuada eros
                                    nec luctus laoreet.</p>
...
@section('script')
    <div>
        <script src="assets/js/jquery-3.7.1.min.js" type="bb643497c5fd5c0e104719b6-text/javascript"></script>

        <script src="assets/js/bootstrap.bundle.min.js" type="bb643497c5fd5c0e104719b6-text/javascript"></script>

        <script src="assets/js/owl.carousel.min.js" type="bb643497c5fd5c0e104719b6-text/javascript"></script>

        <script src="assets/js/jquery.waypoints.js" type="bb643497c5fd5c0e104719b6-text/javascript"></script>
        <script src="assets/js/jquery.counterup.min.js" type="bb643497c5fd5c0e104719b6-text/javascript"></script>

        <script src="assets/plugins/aos/aos.js" type="bb643497c5fd5c0e104719b6-text/javascript"></script>

        <script src="assets/plugins/select2/js/select2.min.js" type="bb643497c5fd5c0e104719b6-text/javascript"></script>

        <script src="assets/js/slick.js" type="bb643497c5fd5c0e104719b6-text/javascript"></script>

        <script src="assets/js/script.js" type="bb643497c5fd5c0e104719b6-text/javascript"></script>
        <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
            data-cf-settings="bb643497c5fd5c0e104719b6-|49" defer></script>
    </div>
@endsection