    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg header-nav p-0">
                    ...
                    <li class="has-submenu">
                        ...
                        <ul class="submenu">
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    <li><a href="{{ route('viewproject') }}">Projects</a></li>
            ...
            <ul class="nav header-navbar-rht reg-head">
                ...
                <li><a href="login.html" class="log-btn"><img src="assets/img/icon/lock.svg"
                            class="me-1" alt="img"> Login</a></li>
                <li><a href="{{ route('createproject') }}" class="login-btn"><i class="feather-plus me-1"></i>Post a
                        Project </a></li>
            </ul>
        </nav>
    </div>
