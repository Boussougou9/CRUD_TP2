        ...
        <div class="row">
            <div class="col-md-12">
                <div class="select-project mb-4">
                    ...
                    <form action= '/update/{{ $element->id }}' method="PUT" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6 ">
                                    <div class="mb-3">
                                        ...
                                        <div class="cal-icon">
                                            <input type="text" class="form-control datetimepicker" name="deadline" placeholder="Choose">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control select" name="freelancer_type">
                                            <option value="0">Select</option>
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control select" name="freelancer_level">
                                            <option>Basic</option>
                                        ...
                                        <div class="title-detail">
                                            ...
                                            <div class="mb-3">
                                                <input type="text" data-role="tagsinput"
                                                    class="input-tags form-control" name="skills"
                                                    value="Web Design" id="services"
                                                    placeholder="UX, UI, App Design, Wireframing, Branding">
                                                <p class="text-muted mb-0">Enter skills for needed for project,
                                                    for best result add 5 or more Skills</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="hours-rate-img">
                                                    <label class="customize-radio">
                                                        <input type="radio" name="budget_type"
                                                            class="hoursradio" checked>
                                                        <img src="assets/img/icon/check-success.svg"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control " name="budget_from" placeholder="15">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control "  name="fixed_price" placeholder="15">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 my-3">
                                    <h4>Attachment</h4>
                                    <p>You can attach more than 1 files to 10 files, Size of the Document should
                                        be Below 2MB </p>
                                </div>
                                <div class="col-lg-12">
                                    ...
                                    <div class="filename">
                                        <ul>
                                            <li>
                                                <h6>Filename 1 <a href="javascript:void(0);"
                                                        class="file-close"><i class="fa fa-close"></i></a>
                                                </h6>
                                            </li>
                                            <li>
                                                <h6>Filename 2 <a href="javascript:void(0);"
                                                        class="file-close"><i class="fa fa-close"></i></a>
                                                </h6>
                                            </li>
                                            <li>
                                                <h6>Filename 3 <a href="javascript:void(0);"
                                                        class="file-close"><i class="fa fa-close"></i></a>
                                                </h6>
                                            </li>
                                        </ul>
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control select" name="language_fluency">
                                            <option>Basic</option>
                                            <option>Intermediate</option>
                                            <option>Professional</option>
                                        </select>
